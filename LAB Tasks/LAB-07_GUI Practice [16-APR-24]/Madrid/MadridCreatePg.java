...
public class MadridCreatePg extends JFrame{
    JPanel panel;
    ImageIcon UCL, FCM;
    JLabel nameL, passL, confirmPassL, uclImgL, fcmImgL, genderL, headingL, emailL, usernameL, playerL, bgCreate, mainHeading;
    ...
    public MadridCreatePg(){
        ...
        panel = new JPanel(){
            ...
            protected void paintComponent(Graphics g) {
                ...
                Image img = new ImageIcon("GUI-bg.jpg").getImage();
